...
from .views import (
    ...
    BrandsView, BrandNew, BrandUpdate, brand_activate_deactivate,
    UnitOfMeasurementView, UnitOfMeasurementNew, UnitOfMeasurementUpdate, unit_of_measurement_activate_deactivate
    )
